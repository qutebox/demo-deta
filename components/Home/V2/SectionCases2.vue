...
const cards = [
  {
    title: t('HOME.V2.CASES.CASE_1.TITLE'),
    desc: t('HOME.V2.CASES.CASE_1.DESC'),
    cta: t('HOME.V2.CASES.CASE_1.CTA'),
    cover: asset('/images/home/slider-2.png'),
    cta_link: '/',
    classes: 'slider-item-enterprises',
  },
  {
    title: t('HOME.V2.CASES.CASE_2.TITLE'),
    desc: t('HOME.V2.CASES.CASE_2.DESC'),
    cta: t('HOME.V2.CASES.CASE_2.CTA'),
    cover: asset('/images/home/slider-4.png'),
    cta_link: '/',
    classes: 'slider-item-hospitals',
  },
  {
    title: t('HOME.V2.CASES.CASE_3.TITLE'),
    desc: t('HOME.V2.CASES.CASE_3.DESC'),
    cta: t('HOME.V2.CASES.CASE_3.CTA'),
    cover: asset('/images/home/slider-1.png'),
    cta_link: '/',
    classes: 'slider-item-insurers',
  },
  {
    title: t('HOME.V2.CASES.CASE_4.TITLE'),
    desc: t('HOME.V2.CASES.CASE_4.DESC'),
    cta: t('HOME.V2.CASES.CASE_4.CTA'),
    cover: asset('/images/home/slider-3.png'),
    cta_link: '/',
    classes: 'slider-item-safety',
  },
  {
    title: t('HOME.V2.CASES.CASE_5.TITLE'),
    desc: t('HOME.V2.CASES.CASE_5.DESC'),
    cta: t('HOME.V2.CASES.CASE_5.CTA'),
    cover: asset('/images/home/slider-4.png'),
    cta_link: '/',
    classes: 'slider-item-safety',
  },
    ...
    <div class="container position-relative">
      ...
      <div class="position-relative">
        <h2 class="font-title mb-4 text-lg-center">
          {{ $t('HOME.V2.CASES.TITLE') }}
        </h2>
        <div class="font-desc text-lg-center">
          <div v-html="$t('HOME.V2.CASES.DESC')"></div>
        </div>
              ...
              >
                <div class="slider-item-card">
                  ...
                  <div class="slider-item-body px-lg-3">
                    <h4 class="slider-item-title mb-3" v-html="card.title"></h4>
                    <div class="slider-item-desc" v-html="card.desc"></div>
